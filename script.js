...
function setActiveSlide(slideData) {
  ...
  document.querySelector(".infoBox").append(
    slideData.infoBox.p,
    slideData.infoBox.codeLinks
    //   slideData.infoBox.extra
  );
...
function createOneSlide(data) {
  ...
  if (data.serverCode.length) {
    ...
    serverLink.innerHTML =
      '<i class="demo-icon icon-github-circled"></i> Serwer';
...
function changeSlide(direction) {
  ...
  setTimeout(() => {
    ...
    infoBox.append(
      nextSlide.infoBox.p,
      nextSlide.infoBox.codeLinks
      //   nextSlide.infoBox.extra
    );
  }, 200);
